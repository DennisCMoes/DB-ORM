...
public class ReflectionUtil {
    private final static Map<Class<? extends Annotation>, FieldMappingStrategy> MAPPING_STRATEGIES = Map.of(
    ...
    public Class<?> getFieldType(Class<?> modelClass, String fieldName) throws NoSuchFieldException {
